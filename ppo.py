...
if __name__ == "__main__":
    ...
    async def do_battle_host():
        ...
        PPOag.load('0.6666666666666666ac_state_dict3.pth')
        PPOag.policy.eval() 
        player = PPO_Player(account_configuration=AccountConfiguration("whitewistle", "cout<<123"),server_configuration=ShowdownServerConfiguration,team=OUR_TEAM,agent=PPOag,Trainingmode=False)
